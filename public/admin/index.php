...
<body>
  <div class="top">
    ...
    <div>
      ...
      <a href="<?= APP_BASE ?>/admin/ops_summary.php" style="margin-right:12px;">Ops Summary</a>
      <a href="<?= APP_BASE ?>/admin/ops_control.php" style="margin-right:12px;">Ops Control</a>
      <a href="<?= APP_BASE ?>/admin/upload_pdf.php" style="margin-right:12px;">Upload PDF</a>
